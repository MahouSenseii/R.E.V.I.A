...
void TestChatterDoesNotInterruptConversation()
{
    ...
    (void)coordinator.Submit(Intent(SpeechOwner::Conversation, SpeechBehavior::Queue));
...
void TestTracingCarriesNoSpeechContent()
{
    ...
    (void)coordinator.Submit(Intent(SpeechOwner::Conversation, SpeechBehavior::Queue, secret));
