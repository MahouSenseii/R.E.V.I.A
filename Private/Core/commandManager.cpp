...
commandOutput commandManager::BuildHelpOutput() const
{
    ...
    stream << "/prefs, /set <key> <value>, /unset <key> - Saved preferences\n";
    stream << "/draw <description> - Diagram or interface mockup, as vector SVG\n";
    stream << "/imagine <description> - Generate a picture with the local image model\n";
    stream << "/write <what>, /revise <n> <change>, /scene, /undo - Working document\n";
    ...
    stream << "/improve [list|show <id>|review <file or area>|accept <id> [why]|reject <id> <why>]"
              " - Her proven proposals for improving her own code\n";
