    ...
    std::string& outError)
{
    ...
    // One log pair per chat worker. Main, Fast, and Expert used to append to the same
    // file, so their load and placement lines interleaved and none of them could be
