...
bool ConversationStylePolicy::IsBriefSocialTurn(const std::string& input)
{
    ...
    constexpr std::string_view turns[] = {
        ...
        "how are you today", "how are you right now", "how are you doing",
        "how are you doing today", "how do you feel today", "how do you feel right now",
        "how are you feeling", "how are you feeling today", "how have you been",
        "are you doing okay", "hows your day", "how is your day",
