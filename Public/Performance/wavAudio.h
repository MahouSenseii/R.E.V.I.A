...
//
// maximumDurationMs refuses a file longer than that from its header alone, before any
// audio is read into memory; pass 0 for no limit. A duration rather than a frame count,
// because only the file knows its sample rate: a frame cap sized for the fastest rate let
// a 48 kHz song four times over the limit decode in full before being turned away.
